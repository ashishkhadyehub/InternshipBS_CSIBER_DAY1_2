<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ERS.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function valid() {
        ...
        if (name == "" || email == "" || phone == "" || dept == "Select" || password=="") {
